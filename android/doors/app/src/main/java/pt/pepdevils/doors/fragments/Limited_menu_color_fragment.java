...
/**
 * Created by pepdevils on 03/08/16.
 */
public class Limited_menu_color_fragment extends MenuPallete_Fragment {
    ...
    private void Warning(){
        ...
        dialog_builder
                .withTitle("Atenção")
                .withMessage("As portas em madeira da linha\n Retiline\n Não são personalizáveis")
    ...
    private void replaceSubMenuFragment(android.support.v4.app.Fragment fragment) {
    ...
    private void removeSubMenuFragment(android.support.v4.app.Fragment fragment) {
