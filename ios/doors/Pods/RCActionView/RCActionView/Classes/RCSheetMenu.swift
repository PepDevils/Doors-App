...
class RCSheetMenu : RCBaseMenu, UITableViewDataSource, UITableViewDelegate {
    ...
    convenience init(title: String, itemTitles: [String], style: RCActionViewStyle) {
        ...
        self.setupWithTitle(title: title, items: itemTitles, subItems: nil)
    }
    ...
    convenience init(title: String, itemTitles: [String], subTitles: [String], style: RCActionViewStyle) {
        ...
        self.setupWithTitle(title: title, items: itemTitles, subItems: subTitles)
    }
    ...
    func tableView(_ tableView: UITableView!, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let _ = cell { } else {
            ...
            cell!.textLabel!.textColor = RCBaseMenu.BaseMenuTextColor(style: self.style)
            cell!.detailTextLabel!.textColor = RCBaseMenu.BaseMenuTextColor(style: self.style)
        }
